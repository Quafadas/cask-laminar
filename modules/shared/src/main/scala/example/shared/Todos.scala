...
object TodoRoutes {
  val listAllTodos: Route[Seq[Todos], Nothing] = Route[Seq[Todos], Nothing](
    "api/todo",
    "get",
    read[Seq[Todos]](_: String),
    SeqLikeWriter(Todos.codec)
  )
  val getATodo: Route[Option[Todos], Nothing] = Route[Option[Todos], Nothing](
    "api/todo/:id",
    "get",
    read[Option[Todos]](_: String),
    OptionWriter(Todos.codec)
  )
  ...
  val updateTodo: Route[Long, Todos] = Route[Long, Todos](
    ...
    _.toLong,
    LongWriter,
    paramReader = Some(read[Todos](_: String))
  )
  val deleteTodo: Route[Int, Nothing] =
    Route[Int, Nothing]("api/todo/:id", "delete", _.toInt, IntWriter)
}
...
object SuggestionRoutes {
  val allSuggestions: Route[Seq[String], Nothing] = Route[Seq[String], Nothing](
    "/get-suggestions",
    "get",
    read[Seq[String]](_: String),
    SeqLikeWriter(StringWriter)
  )
